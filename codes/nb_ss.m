...
disp(' ')
    ...
    % (Pricetaking baseline with credit, money and DM capital):
        ...
        THETA_B = 0.899; % Since PT model has no THETA_B, we fix THETA_B   
                            % such that Markup = 30%.
...
%     [meul,keul] = nb_graph_steady(xss,A,B,C,ETA,SIGMA,KAPPA,ALPHA,...
%                                  BETA,GAMA,...
...
NAME_SSMAT = {'K','X','H','HTOT','q_cz','q','I','w',...
    'P','Py_ii','Py_ji','y_ii','y_ji','NX','GDP','MDE', 'LS', 'Markup'};
