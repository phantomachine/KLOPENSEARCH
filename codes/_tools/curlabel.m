function curlabel(txt,size)

% curlabel('txt',size)  Puts  a  text  label  on  the  end  of a line
% pointing  to  a  curve.  The size of the font is size. 
% Click on the curve where you want the
