...
disp('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ')
disp('PB_CALIBRA_SS.M: STEP 1. SET BASELINE PARAMETERS ...')
disp('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ')
disp(' ')
...
disp('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ')
disp('PB_CALIBRA_SS.M: STEP 2. SOLVE FOR STEADY STATE ...')
disp('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ')
disp(' ')
...
NAME_cabparams = {'k','A','PHI','B','THETA_B'};
...
lb = [k_lb,A_lb,PHI_lb,B_lb,THETA_B_lb,...
...
PHI_ub      = 1.6;
B_ub        = 10;
THETA_B_ub  = 0.999999999;
H_ub        = 0.4;
KY_ub       = 8.92;
NTS_ub      = 0.52;
MKP_ub      = 0.35;

ub = [k_ub,A_ub,PHI_ub,B_ub,THETA_B_lb,...
...
x0 = [k0, A0, PHI0, THETA_B0, B0, H0, KY0, NTS0, MKP0 ];

% Do constraint minimization - calibration (1st moment matching)
[xss,fmin,exitflag,fmcoutput,lm] = fmincon(@ssmapobj2pb,x0,[],[],[],[],...
                                            lb,ub,@ssmapcon2pb,options0,...
...
elseif exitflag == 0 || exitflag == -1 || exitflag == -2
    warning('PB_CALIBRA_SS:Error','Calibration task not completed...')
    break
end
...
% Pin down other steady state variables:
    ...
    THETA_B = xss(5);  % in [0,1]
    H1 = xss(6);        % in (0,1)
    KYratio = xss(7);  % > 0
	
    NTS = xss(8);     % in (0,1)
    MKP = xss(9);     % in (0,m), m < +infty
    
[REL_Pyh1,K1,qz1,q1,X1,Yh1,I1,yh1,yf1,yf2,yh2,...
