% % PT_RUN.m
% % -----------------------------------------------------------------------
% % This SCRIPT executes the model benchmark pricetaking model with credit
% % and money in DM.
% % 
% % INPUT: none
% % 
...
if RUN_OLD == 0
    ...
    disp('STEP 5: Evaluating symbolic derivatives ... Please wait')
    ...
    % % ===================================================================
        ...
        disp(' ');                                         
        disp(['STEP 6: Solving for REE. Policy function approx. = ',...
                                                          int2str(approx)]) 
...
%         if sum(model.options.IMPSELECT - [15,40,33,31]) == 0
...
%         end
    ...
    if MOMENTS == 1
        ...
        model.options.MOM_SELECT_y = [15,33,38,3,36,31,34,40];                     
