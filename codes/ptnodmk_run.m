% % PTNODMK_RUN.m
% % -----------------------------------------------------------------------
% % This SCRIPT executes the model without capital in the DM, but has
% % credit and money in the DM. "Dichotomy" model.
% % 
% % INPUT: none
% % 
...
model = pt_eq;  % Same as in the baseline case: Price-taking with DM capital
...
% % =======================================================================
    ...
    elseif approx == 2
        ...
        save ptnodmk_solve gx hx gxx hxx
    end
...
% % Options:
model.options.IMPSELECT = [15,31,32,33,40,38,34,3];
model.options.SHOCKSELECT = [1,3];
model.options.HORIZON = 30;
model.options.LINETYPE = {'-or'}; %{'db'};
...
if MOMENTS == 1
    ...
    model.options.MOM_SELECT_y = [15,33,34,38,3,36];                     %  1 : 33
    model.options.MOM_SELECT_x = [];                       % 33 : 39
    ...
    model.options.CROSSCOUNTRY = [  33, 15;                % (RER, E) 
                                    33, 26;                % (RER, NX)
                                    33, 34 ];              % (RER, C/C*)
