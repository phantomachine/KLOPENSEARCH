% % NB_CALIBRA_RUN.m
% % -----------------------------------------------------------------------
% % This SCRIPT executes the Nash Bargaining model with credit
...
% % =======================================================================
    ...
    elseif approx == 2
        ...
        save nb_calibra_solve gx hx gxx hxx
...
% % -----------------------------------------------------------------------
    ...
    for figno = 1:2 % loop for 2 separate figures
        ...
        if figno == 1
            model.options.IMPSELECT = [15,40,33,31]; %[15,31,32,33,40,38,34,3]; 
...
if MOMENTS == 1
    ...
    model.options.MOM_SELECT_y = [15,33,34,38,3,36];  
