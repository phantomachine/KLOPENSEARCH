function [REL_Pyh1,K1,q_czech1,q1,X1,Yh1,I1,yh1,yf1,yf2,yh2,...
            REL_Pyf1,w1,RER,E,P1,Pyh1,Pyf1,Pyf2,Pyh2,NX1,GDP1] = ...
    ...
    q = ((((1-BTHETA)*(1/BETA-1+SIGMA*KAPPA) - SIGMA*KAPPA)*C*K^(PHI-1))...
                    /(BTHETA*PHI*(1/BETA-1+SIGMA*KAPPA)) )^(1/(ETA+PHI-1));
                
    X = ((1+TAU_X)*(1-TAU_H)*B*REL_Pyh*ZBAR*F_h(K,H,ALPHA)/A)^(1/GAMA);
    ...
    P1 = A*epsi1 /(w1*(1-TAU_H)*g(q,K,PHI));      % inverse real balance
    P2 = P1;
