...
% g:
g_PROP1 = g_prop(q1,K1,Z1,THETA_B,PHI,ETA,b,C);
g_PROP2 = g_prop(q2,K2,Z2,THETA_B,PHI,ETA,b,C);
...
% g_q:
g_PROP_q1 = g_prop_q(q1,K1,Z1,THETA_B,PHI,ETA,b,C);
g_PROP_q2 = g_prop_q(q2,K2,Z2,THETA_B,PHI,ETA,b,C);

% g_q+:
g_PROP_q1p = g_prop_q(q1p,K1p,Z1p,THETA_B,PHI,ETA,b,C);
g_PROP_q2p = g_prop_q(q2p,K2p,Z2p,THETA_B,PHI,ETA,b,C);

% Gamma function in DM
gamma_PROP_K1p = gamma_prop(q1p,K1p,Z1p,THETA_B,PHI,ETA,b,C);
gamma_PROP_Kz1p = gamma_prop(qz1p,K1p,Z1p,THETA_B,PHI,ETA,b,C);

gamma_PROP_K2p = gamma_prop(q2p,K2p,Z2p,THETA_B,PHI,ETA,b,C);
gamma_PROP_Kz2p = gamma_prop(qz2p,K2p,Z2p,THETA_B,PHI,ETA,b,C);
...
f3 = MU_X1 ...
    ...
    *( 1 - SIGMA*KAPPA + SIGMA*KAPPA*MU_q1p/g_PROP_q1p );
f4 = MU_X2 ...
    - BETA*MU_X2p*(P2/P2p)*(1/psi2)...
    *( 1 - SIGMA*KAPPA + SIGMA*KAPPA*MU_q2p/g_PROP_q2p );
% Pins down (q1, q2)
% KAPPA: Added 04/05/2010
...
f17 = A*psi1/(P1*(1-TAU_H)*w1) - g_PROP1; 
f18 = A*psi2/(P2*(1-TAU_H)*w2) - g_PROP2;
% Pins down (P1, P2)
